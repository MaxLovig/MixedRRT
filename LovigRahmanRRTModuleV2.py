...
class circleEstimator:
    ...
    def getShape(self):
        ...
        axScrambler.set_title("Actual Distribution")
...
class mixedModel:
    ...
    def getMinPQ(self,bins,cieling,aFunction):
...
constantA = constantEstimator(a)
MMF = mixedModel(n,epochs,tPi,zPi,False)
print(MMF.run(p,q,a))
print(getTrueMSE(n,tPi,zPi,p,q,a,False))
plt.show()
